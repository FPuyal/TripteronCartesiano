...
bool I2CWrapper::Read(uint16_t& raw_value) {
    ...
    // HAL_StatusTypeDef lectura = HAL_I2C_Mem_Read(mHi2c, mDevAddress, mMemAddress, I2C_MEMADD_SIZE_8BIT, buffer, 2, 2);

    if (HAL_I2C_Mem_Read(mHi2c, mDevAddress, mMemAddress, I2C_MEMADD_SIZE_8BIT, buffer, 2, 2) == HAL_OK){
